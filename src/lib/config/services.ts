...
export const serviceCatalog = {
    ...
    evalInteligencia: {
        id: 'evalInteligencia',
        name: 'Evaluación Intelectual Adultos',
        price: paymentConfig.pricing.evalInteligencia,
        description: 'Evaluación de capacidad intelectual en adultos con WAIS-IV. Incluye 4 sesiones, aplicación completa, sesión de feedback y entrega de informe con perfil cognitivo.',
        duration: '4 sesiones',
        includes: ['WAIS-IV', 'Análisis de índices', 'Perfil cognitivo', 'Recomendaciones'],
    },
